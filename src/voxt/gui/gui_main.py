...
from voxt.core.voxt_core import CoreProcessThread, show_options_dialog, _create_styled_checkbox
...
class VoxtApp(QWidget):
    def __init__(self):
        ...
        self.icon_idle = QIcon(str(ASSETS_DIR / "voxt-0.png"))
        self.icons_recording = [QIcon(str(ASSETS_DIR / f"voxt-{i}.png")) for i in range(1, 10)]
        self.icons_transcribing = [
            QIcon(str(ASSETS_DIR / n)) for n in ["voxt-0.png", "voxt-9.png", "voxt-1.png", "voxt-9.png"]
        ]
        self.tray = QSystemTrayIcon(self.icon_idle, self)
        self.tray.setToolTip("VOXT")
        self.tray.show()
